...
sir nou;
int lungime_nou;
lungime_nou=strlen(prim)+strlen(sir_adaug.prim)+1;//lungimea sirului final este lungimea primului sir +lungimea celui de-al doilea
...
text=(sir)"2007 "+ text; // ? conversie ? atribuire
