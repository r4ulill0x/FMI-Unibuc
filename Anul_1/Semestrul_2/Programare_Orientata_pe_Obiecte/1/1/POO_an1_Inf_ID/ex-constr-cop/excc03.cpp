...
int main()
{
        ...
        v2.copiere(v1); // transmiterea argumentului prin valoare (copiere in variabila temporara)
                        // se folosesc: constructorul de copiere la transmiterea valorii argumentului
                        // si destructorul dupa revenire
		v2.arata(); 
